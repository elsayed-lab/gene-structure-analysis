...
write.xlsx(sl_sites$combined, file=sl_xlsx, sheetName="combined")
write.xlsx(polya_sites$combined, file=polya_xlsx, sheetName="combined")

for (stage in CONFIG$stages) {
    write.xlsx(sl_sites[[stage]], file=sl_xlsx, sheetName=stage, append=TRUE)
    write.xlsx(polya_sites[[stage]], file=polya_xlsx, sheetName=stage, append=TRUE)
}
