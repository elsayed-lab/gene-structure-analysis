...
cat(sprintf("- 5'UTR GC-richness: %0.1f%%\n", median(utr5_stats_combined_filtered$gc) * 100))
cat(sprintf("- 5'UTR CT-richness: %0.1f%%\n", median(utr5_stats_combined_filtered$ct) * 100))
cat(sprintf("- 3'UTR GC-richness: %0.1f%%\n", median(utr3_stats_combined_filtered$gc) * 100))
cat(sprintf("- 3'UTR CT-richness: %0.1f%%\n", median(utr3_stats_combined_filtered$ct) * 100))
