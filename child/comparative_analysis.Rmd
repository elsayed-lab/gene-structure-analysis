...
```{r figure_X19_tritryp_gene_structure, fig.height=600/192, fig.width=1600/192, dev=c(opts_chunk$get('dev'), 'svglite'), fig.cap='**Figure X19** TriTryp gene structure comparison'}
...
kable(table_1, caption='**Table 1** TriTryp comparative gene structure.')
```
