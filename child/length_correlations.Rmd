...
```{r length_correlations, fig.show='hold', out.width='290px', warning=FALSE, fig.cap="**Figure 2**: UTR and CDS length correlations"}
...
rownames(table4) <- c("5'UTR vs. CDS", "3'UTR vs. CDS", "5'UTR vs. 3'UTR")
colnames(table4) <- c("Spearman's rho")

xkable(table4, caption='**Table 4**: Percent genes containing N or more reads mapping to the specified feature.')
```
