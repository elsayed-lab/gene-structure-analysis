...
table_S7 <- merge(primary_site_props, alt_site_props, by='acceptor_site_3nt')
colnames(table_S7) <- c('site', 'Primary', 'Alternative downstream', 
                         'Alternative upstream')
table_S7 <- table_S7 %>% 
    arrange(desc(Primary)) %>%
    column_to_rownames('site')
table_S7 <- round(table_S7 * 100, 2)
table_S7[is.na(table_S7)] <- 0

kable(table_S7, caption='**Table S7** Frequency of preceeding nucleotide for primary and alternative canonical trans-splicing acceptor sites.')
```
