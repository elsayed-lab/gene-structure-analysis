...
```{r figure_XX_polypyr_sequence_cluster_heatmap, cache=TRUE, autodep=TRUE}
...
```{r figure_XX_polypyr_tract_cluster, results='asis', cache=TRUE, autodep=TRUE, fig.width=3840/192, fig.height=720/192, dpi=192}
