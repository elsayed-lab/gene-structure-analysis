...
```{r polpyrimidine_tract_logo_global, fig.width=7680/192, fig.height=720/192, dpi=192}
# perform an MSA
...
# find boundaries of main alignment (here, positions where at least ~1/3 of
# the sequences aligned)
indices <- which(colSums(pfm) >= (0.32 * length(seqs)))
from <- indices[1]
to <- last(indices)
...
```{r, results='asis', cache=TRUE, autodep=TRUE, fig.width=3840/192, fig.height=720/192, dpi=192}
