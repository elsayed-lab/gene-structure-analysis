...
```{r results='asis'}
# Table X11: Polypyrimidine tract lengths
polypyrimidine_lengths <- polypyr_combined$length

table_X11 <- data.frame(length=c(min(polypyrimidine_lengths),
                                mean(polypyrimidine_lengths),
                                median(polypyrimidine_lengths),
                                max(polypyrimidine_lengths)))
rownames(table_X11) <- c('min', 'mean', 'median', 'max')
xkable(t(table_X11), caption='**Table X11** Polypyrimidine tract length statistics.')
```
