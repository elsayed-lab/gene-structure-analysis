...
#
infile="../../input/lmajor_friedlin/S01_num_reads_host.csv"
echo "sample_id,num_reads_host" > $infile

for x in $SCRATCH/utr_analysis/lmajor-infecting-hsapiens-*/common/HPGL*/tophat/mapped_to_nontarget/align_summary.txt; do
